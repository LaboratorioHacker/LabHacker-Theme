<?php get_header(); ?>
	...
	<div class="row postsindex" style="padding-top:20px;">
		...
		<div class="col-sm-8">
			...
			<div class="jumbotron">
				<h3 style="border-bottom:1px solid #fff;padding-bottom:10px;">Exibindo todos os posts da categoria <b><?php single_cat_title(); ?></b></h3>
			...
			<?php endwhile; else : ?>
				...
				<div class="jumbotron">
					...
					<p>Esta categoria ainda não possui nenhum post.</p>
