<?php get_header(); ?>
	...
	<div class="row postsindex" style="padding-top:20px;">
		...
		<div class="col-sm-8">
			...
			<div class="jumbotron">
				<h3 style="border-bottom:1px solid #fff;padding-bottom:10px;">Exibindo todos os posts<?php
						if ( is_day() ) :
							echo " do dia <b>".get_the_date()."</b>";

						elseif ( is_month() ) :
							echo " de <b>".get_the_date( 'F' )." de ".get_the_date( 'Y' )."</b>";
						elseif ( is_year() ) :
							echo " do ano de <b>".get_the_date( 'Y' )."</b>";
						endif;
					?></h3>
			...
			<?php endwhile; else : ?>
				...
				<div class="jumbotron">
					...
					<p>Nenhum post foi publicado nesta data.</p>
