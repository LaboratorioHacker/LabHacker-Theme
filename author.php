	...
	<div class="row postsindex" style="padding-top:20px;">
		...
		<div class="col-sm-8">
			...
			<div class="jumbotron">
				...
				<h3 style="border-bottom:1px solid #fff;padding-bottom:10px;">Exibindo todos os posts de <b><?php the_author(); ?></b></h3>
			...
			<?php endwhile; else : ?>
				...
				<div class="jumbotron">
					...
					<p>Este autor ainda não escreveu nenhum post.</p>
